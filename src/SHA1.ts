...
function b64_sha1(s: any) {
  return rstr2b64(rstr_sha1(str2rstr_utf8(s)))
}
function any_sha1(s: any, e: any) {
  return rstr2any(rstr_sha1(str2rstr_utf8(s)), e)
}
function hex_hmac_sha1(k: any, d: any) {
  return rstr2hex(rstr_hmac_sha1(str2rstr_utf8(k), str2rstr_utf8(d)))
}
function b64_hmac_sha1(k: any, d: any) {
  return rstr2b64(rstr_hmac_sha1(str2rstr_utf8(k), str2rstr_utf8(d)))
}
function any_hmac_sha1(k: any, d: any, e: any) {
 ...
 */
function rstr_sha1(s: string | any[]) {
 ...
 */
function rstr_hmac_sha1(key: string | any[], data: string | any[]) {
 ...
 */
function binb2rstr(input: string | any[]) {
  var output = ''
 ...
 */
function binb_sha1(x: string | any[], len: number) {
  /* append padding */
...
export const HMACSHA1 = function (key: any, data: any) {
